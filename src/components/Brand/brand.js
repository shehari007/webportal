    ...
    <>
       ...
       <Navbar bg="dark" variant="dark">
        <Container>
          ...
          <a href='https://www.instagram.com/' target="_blank" rel="noopener noreferrer"><img src='./inshare.png' alt="" style={{height: '16px', width:'16px', marginLeft: '10px'}}/></a>
          <a href='https://www.twitter.com/' target="_blank" rel="noopener noreferrer"><img src='./twshare.png' alt="" style={{height:'16px', width:'16px',marginLeft:'10px'}} /></a>
          </h4>
