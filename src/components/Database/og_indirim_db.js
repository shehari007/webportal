import axios from '..//Database/axios_api/axios_ogindirim'
...
export default class database extends Component {
            ...
            .then(res => {
                ...
                
                {
                    ...
                    return <tbody>
                            ...
                            <td key={index}>{data.og_indirim}</td>
    ...
    render() {
        return (
            <><div align="center">
                <h1>Siirt OTELLER ve KONAKLAMA</h1>
            </div>
            <div>
                    <Table striped bordered hover responsive="lg" variant='dark'style={{textAlign: 'left'}}>
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>ADI</th>
