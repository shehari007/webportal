...
const Reklam_servis = () => {
    return (
        <><Helmet>
            <title>Reklam-Verin Uygun fiyatlarla işinizi internete taşıyın!</title>
        </Helmet>
            <div className="row" style={{ margin: '2%' }}>
                <h1 align="center">Uygun fiyatlarla işinizi internete taşıyın!</h1>

                <div className="col-md-6" style={{ marginTop: '5%' }}>
                    <p>Findme.com reklam paketleri hakkında bilgi
                        almak veya işletmeniz için websitesi yaptırmak isterseniz
                        aşağıdaki talep formunu lütfen doldurun. Ekibimiz sizinle hemen irtibata geçecektir.</p>
                    <br />
                    <Form>
                        <Row className="mb-3">
                ...
                <div className="col-md-6" align="center" style={{ marginTop: '12%' }}>
